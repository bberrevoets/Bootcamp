...
public class BasketAuthorizationHandler : AuthorizationHandler<OwnerOrAdminRequirement, CustomerBasket>
{
        ...
        CustomerBasket resource)
    {
        ...
        if (string.IsNullOrEmpty(currentUserId)) return Task.CompletedTask;
